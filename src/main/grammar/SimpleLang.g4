...
functionDecl: (Int | Void) Identifier LeftParen paramList? RightParen compoundStatement;

paramList
    : (Int | Void) Identifier (',' (Int | Void) Identifier)*
    ;


variableDeclaration
    : Int Identifier variableInitializer? Semi
    ;
