...
public interface SimpleLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SimpleLangParser#functionDecl}.
	 * @param ctx the parse tree
	 */
	void enterFunctionDecl(SimpleLangParser.FunctionDeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLangParser#functionDecl}.
	 * @param ctx the parse tree
	 */
	void exitFunctionDecl(SimpleLangParser.FunctionDeclContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SimpleLangParser#variableDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterVariableDeclaration(SimpleLangParser.VariableDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLangParser#variableDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitVariableDeclaration(SimpleLangParser.VariableDeclarationContext ctx);
	/**
	 * Enter a parse tree produced by {@link SimpleLangParser#variableInitializer}.
	 * @param ctx the parse tree
	 */
	void enterVariableInitializer(SimpleLangParser.VariableInitializerContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLangParser#variableInitializer}.
	 * @param ctx the parse tree
	 */
	void exitVariableInitializer(SimpleLangParser.VariableInitializerContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SimpleLangParser#postIncrementExpression}.
	 * @param ctx the parse tree
	 */
	void enterPostIncrementExpression(SimpleLangParser.PostIncrementExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLangParser#postIncrementExpression}.
	 * @param ctx the parse tree
	 */
	void exitPostIncrementExpression(SimpleLangParser.PostIncrementExpressionContext ctx);
	/**
